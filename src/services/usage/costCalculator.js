...
export const PRICING_TABLE = Object.freeze({
  "search:tavily": Object.freeze({
    ...
    service: "search",
    unit: "credit",
    pricePerUnitUsd: 0.008,
    effectiveFrom: "2026-09-01",
    source: "https://www.tavily.com/pricing",
  }),
  "search:exa": Object.freeze({
    provider: "exa",
    service: "search",
    unit: "request",
    pricePerUnitUsd: 0.007,
    includedResults: 10,
    additionalResultPricePerUnitUsd: 0.001,
    effectiveFrom: "2026-09-01",
  ...
  "search:you": Object.freeze({
    ...
    effectiveFrom: "2026-09-01",
    source: "https://you.com/docs/administration/billing",
  }),
  "gemini:gemini-3.5-flash-lite": Object.freeze({
    provider: "gemini",
    service: "gemini",
    unit: "token",
...
export function calculateUsageCost({
  ...
  if (service === "gemini") {
    ...
    return (input / 1_000_000) * pricing.inputPricePerMillionUsd
      + (output / 1_000_000) * pricing.outputPricePerMillionUsd;
  }

  if (provider === "tavily") {
    return (normalizeRate(credits) ?? 0) * pricing.pricePerUnitUsd;
  }

  const requestCount = normalizeRate(requests) ?? 0;
  if (provider === "exa" && pricing.includedResults && resultCount > pricing.includedResults) {
    const extraResults = resultCount - pricing.includedResults;
    return requestCount * pricing.pricePerUnitUsd + extraResults * pricing.additionalResultPricePerUnitUsd;
  }
